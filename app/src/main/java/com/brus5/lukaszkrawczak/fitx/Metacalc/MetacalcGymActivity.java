...
public class MetacalcGymActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar1 = (Toolbar) findViewById(R.id.toolbar5);
        setSupportActionBar(toolbar1);
        getWindow().setStatusBarColor(ContextCompat.getColor(MetacalcGymActivity.this, R.color.color_main_activity_statusbar));
        initialization();
        seekbars();

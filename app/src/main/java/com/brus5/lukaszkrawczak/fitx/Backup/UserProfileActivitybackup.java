...
//
//public class UserProfileActivitybackup extends AppCompatActivity {
//
//    private final static String TAG = "UserProfileActivitybackup";
//
...
//
//                AlertDialog.Builder alert = new AlertDialog.Builder(UserProfileActivitybackup.this);
...
//                                Intent intent = new Intent(UserProfileActivitybackup.this,UserLoginActivity.class);
...
//                    if (success) {
//                        AlertDialog.Builder builder = new AlertDialog.Builder(UserProfileActivitybackup.this);
//                        builder.setMessage("username up to date")
//                                .setNegativeButton("OK", null)
//                                .create()
//                                .show();
//                        Intent intent1 = new Intent(UserProfileActivitybackup.this,UserLoginActivity.class);
//                        UserProfileActivitybackup.this.startActivity(intent1);
//                    } else {
//
//                    }
...
//                }
//                wynik = response;
//                Log.e("UserProfileActivitybackup",    "ResponseListener "  +response);
//                Log.e("UserProfileActivitybackup",    "wynik "             +wynik);
//                response = username;
//                String result;
...
//        RequestQueue queue1 = Volley.newRequestQueue(UserProfileActivitybackup.this);
...
//
//                Log.e("UserProfileActivitybackup",    "updatename "        + updatename);
//                Log.e("UserProfileActivitybackup",    "username "          + username);
//                Log.e("UserProfileActivitybackup",    "updateusername "    + updateusername);
//                Log.e("UserProfileActivitybackup",    "updatebirthday "    + updatebirthday);
//                Log.e("UserProfileActivitybackup",    "updatepassword "    + updatepassword);
//                Log.e("UserProfileActivitybackup",    "updateemail "       + updateemail);
//
...
//                                boolean success = jsonObject.getBoolean("success");
//                                if (success) {
//                                    final Intent intent = new Intent(UserProfileActivitybackup.this, UserLoginActivity.class);
//                                    AlertDialog.Builder builder = new AlertDialog.Builder(UserProfileActivitybackup.this);
//                                    builder.setMessage("Information changed, you'll be logged off")
//                                            .setPositiveButton("YES", new DialogInterface.OnClickListener() {
//                                                @Override
//                                                public void onClick(DialogInterface dialogInterface, int i) {
//                                                    UserProfileActivitybackup.this.startActivity(intent);
//                                                }
//                                            })
//                                            .show();
//                                }
...
//
//
//                            Log.e("UserProfileActivitybackup", "response " + response);
//                        }
//                    }
//
//
...
////                RequestQueue queue = Volley.newRequestQueue(UserProfileActivitybackup.this);
